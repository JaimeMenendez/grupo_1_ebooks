var subcategoryPython = ['Django', 'Flask', 'Pandas', 'Machine learning','Deep learning','','','','',''];
var subcategoryElectronica = ['Electrónica de potencia','Análisis de circuitos CC','Análisis de circuitos CA','Electrónica digital','Semiconductores','Electrónica Industrial','Control','','',''];
var subcategoryIntArtificial = ['Redes neuronales','Machine learning','Deep learning','Máquinas vectoriales','Análisis de PCA','Aprendizaje supervizado','Aprendizaje no supervizado','Clusttering','',''];
var subcategoryRedes = ['PAN','LAN','CAN','WLAN','WAN','MAN','SAN','GAN','',''];
var subcategoryMecanica = ['Propiedades mecánicas','Dinámica','Estática','Fluidos','Aire acondicionado','Máquinas eléctricas','Mecánica de materiales','Termodinámica','Mecánica automotriz',''];
var subcategoryMedicina = ['Diabetes','Cardiología','Neurología','Epidemiología','Farmacología','Anestesiología','Oncología','Pediatría','Bacteriología','Microbiología'];
var subcategoryQuimica = ['Química orgánica','Química inorgánica','Polímeros','Estequiometría', 'Nuclear','Estado sólido','Organometálica','Forense','Ambiental',''];
var subcategoryBiotecnologia1 = ['Bio1','Bio2','Bio3','Bio4','Bio5','Bio6','Bio7','Bio8','Bio9','Bio10'];
var subcategoryBiotecnologia2 = ['Mis','ojos','son','más','hermosos','cuando','lees','através','de','ellos'];
var subcategoryBiotecnologia3 = ['InsideBooks','es','un','e-commerce','de','venta','de','libros','universitarios',''];
                        
function myFunction(button_id) {
    let prueba = document.querySelectorAll('#subcategory');
    switch(button_id){
        case "programacion": 
